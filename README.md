...
- **DiffusionNet**: Nicholas Sharp, Souhaib Attaiki, Keenan Crane, Maks Ovsjanikov. "DiffusionNet: Discretization
  ...
  2022). [[paper]](https://arxiv.org/abs/2012.00888) [[code]](https://github.com/nmwsharp/diffusion-net)

- **SubdivNet**: Shi-Min Hu, Zheng-Ning Liu, Meng-Hao Guo, Jun-Xiong Cai, Jiahui Huang, Tai-Jiang Mu, Ralph R. Martin. "
  Subdivision-Based Mesh Convolution Networks", TOG(
  2022). [[paper]](https://arxiv.org/abs/2106.02285) [[code]](https://github.com/lzhengning/SubdivNet)

- **Laplacian Mesh Transformer**: Xiao-Juan Li, Jie Yang, Fang-Lue Zhan. "Laplacian Mesh Transformer: Dual Attention and
...
- Amit Kohli, Vincent Sitzmann, Gordon Wetzstein. "Semantic Implicit Neural Scene RepresentationsWith Semi-Supervised
  Training", 3DV(
  2020). [[project]](https://www.computationalimaging.org/publications/semantic-srn/) [[paper]](https://arxiv.org/abs/2003.12673) [[code]](https://github.com/apsk14/semantic_scene_representations)

- Zhenyu Shu, Xiaoyong Shen, Shiqing Xin, Qingjun Chang, Jieqing Feng, Ladislav Kavan, Ligang Liu. "Scribble-Based 3D
...
- Jung Lee, Seokhun Kim, Sun-Jeong Kim. "Mesh segmentation based on curvatures using the GPU", MTA(
  2014). [[paper]](https://link.springer.com/article/10.1007%2Fs11042-014-2104-1)
...
- Oscar Kin-Chung Au, Youyi Zheng, Menglin Chen, Pengfei Xu, Chiew-Lan Tai. "Mesh Segmentation with Concavity-aware
  Fields", TVCG(2012). [[paper]](https://ieeexplore.ieee.org/document/5963664) :fire:
...
- Shapira Lior, Shamir Ariel, Cohen-Or Daniel. "Consistent mesh partitioning and skeletonisation using the shape
  diameter function", TVC(2008). [[paper]](https://www.cs.jhu.edu/~misha/ReadingSeminar/Papers/Shapira08.pdf) :fire:
...
- **BACON**: David B. Lindell, Dave Van Veen, Jeong Joon Park, Gordon Wetzstein. "BACON: Band-limited Coordinate
  ...
  2022). [[project]](http://www.computationalimaging.org/publications/bacon/) [[paper]](https://arxiv.org/abs/2112.04645) [[code]](https://github.com/computational-imaging/bacon)

- **PSSNet**: Weixiao Gao, Liangliang Nan, Bas Boom, Hugo Ledoux. "PSSNet: Planarity-sensible Semantic Segmentation of
  Large-scale Urban Meshes", arXiv(2022). [[paper]](https://arxiv.org/abs/2202.03209)
...
- **VMNet**: Zeyu Hu, Xuyang Bai, Jiaxiang Shang, Runze Zhang, Jiayu Dong, Xin Wang, Guangyuan Sun, Hongbo Fu, Chiew-Lan
  ...
  2021). [[paper]](https://arxiv.org/abs/2107.13824) [[code]](https://github.com/hzykent/VMNet)

- **Deep3DMM**: Zhixiang Chen, Tae-Kyun Kim. "Learning Feature Aggregation for Deep 3D Morphable Models", arXiv(
  2021). [[paper]](https://arxiv.org/abs/2105.02173) [[code]](https://github.com/zchen06/Deep3DMM)
...
- **MFNs**: Rizal Fathony, Anit Kumar Sahu, Devin Willmott, J.Zico Kolter. "Multiplicative Filter Networks", ICLR(
  2021). [[paper]](https://openreview.net/forum?id=OmtmcPkkhT) [[code]](https://github.com/boschresearch/multiplicative-filter-networks)

- **IDF**: Wang Yifan, Lukas Rahmann, Olga Sorkine-Hornung. "Geometry-Consistent Neural Shape Representation with
  Implicit Displacement Fields", ICLR(
  2022). [[project]](https://yifita.github.io/publication/idf/) [[paper]](https://arxiv.org/abs/2106.05187) [[code]](https://github.com/yifita/idf)
...
- STEVEN L. SONG, WEIQI SHI, MICHAEL REED. "Accurate Face Rig Approximation with Deep Differential Subspace
  Reconstruction", TOG(2020). [[paper]](https://arxiv.org/abs/2006.01746)
...
- Xinge Li, Yongjie Jessica Zhang, Xuyang Yang, Haibo Xu, Guoliang Xu. "Point cloud surface segmentation based on
  volumetric eigenfunctions of the Laplace-Beltrami operator", CAGD(
  2019). [[paper]](https://www.sciencedirect.com/science/article/abs/pii/S0167839619300147?via%3Dihub)

- **SE-Net**: Jie Hu, Li Shen, Samuel Albanie, Gang Sun, Enhua Wu. "Squeeze-and-Excitation Networks", CVPR(
  2018). [[paper]](https://arxiv.org/abs/1709.01507) [[code]](https://github.com/hujie-frank/SENet) :star::fire:
...
- **Deep Functional Maps**: Or Litany, Tal Remez, Emanuele Rodolà, Alex M. Bronstein, Michael M. Bronstein. "Deep
  ...
  2017). [[paper]](https://arxiv.org/abs/1704.08686) [[code]](https://github.com/orlitany/DeepFunctionalMaps) :fire:
...
- Jonathan Masci, Davide Boscaini, Michael M. Bronstein, Pierre Vandergheynst. "Geodesic Convolutional Neural Networks
  on Riemannian Manifolds", ICCVW(2015). [[paper]](https://arxiv.org/abs/1501.06297) :fire:
...
- **Functional maps**: Maks Ovsjanikov, Mirela Ben-Chen, Justin Solomon, Adrian Butscher, Leonidas Guibas. "Functional
  ...
  2012). [[paper]](https://people.csail.mit.edu/jsolomon/assets/fmaps.pdf) :fire:
...
- **Shape Google**: Maks Ovsjanikov, Alexander M. Bronstein, Michael M. Bronstein, Leonidas J. Guibas. "Shape Google: a
  computer vision approach to isometry invariant shape retrieval", ICCV(
...
- **common-3d-test-models**: Alec Jacobson, jmespadero,
  purvigoel. [[github]](https://github.com/QiujieDong/common-3d-test-models) :fire:

- **SUM**: Weixiao Gao, Liangliang Nan, Bas Boom, Hugo Ledoux. "SUM: A Benchmark Dataset of Semantic Urban Meshes",
