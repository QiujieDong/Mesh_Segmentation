...
- Xiangru Huang, Haitao Yang, Etienne Vouga, Qixing Huang. "Dense Correspondences between Human Bodies via Learning Transformation Synchronization on Graphs", NeurIPS(2020). [[paper]](https://proceedings.neurips.cc//paper/2020/hash/ca7be8306ecc3f5fa30ff2c41e64fa7b-Abstract.html) [[code]](https://github.com/xiangruhuang/HumanCorresViaLearn2Sync)
...
- Mikhail Belkin, Partha Niyogi. "Laplacian Eigenmaps for Dimensionality Reduction and Data Representation", Neural Computation(2003). [[paper]](https://direct.mit.edu/neco/article-pdf/15/6/1373/815527/089976603321780317.pdf) :fire:
...
- **Thingi10K**: Qingnan Zhou, Alec Jacobson. "Thingi10K: A Dataset of 10,000 3D-Printing Models", arXiv(2016). [[project]](https://ten-thousand-models.appspot.com/) [[paper]](https://arxiv.org/abs/1605.04797) :fire:
